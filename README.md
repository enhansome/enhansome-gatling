...
* [Source code](https://github.com/gatling/gatling) ⭐ 6,952 | 🐛 19 | 🌐 Scala | 📅 2026-08-25
...
* [Distributed Gatling](https://github.com/Abiy/distGatling) ⭐ 102 | 🐛 48 | 🌐 CSS | 📅 2023-01-04 - Solution to run Gatling simulation tests in a distributed/cluster environment.
* [gatling-operator](https://github.com/st-tech/gatling-operator) ⭐ 85 | 🐛 17 | 🌐 Go | 📅 2026-03-25 - Automating distributed Gatling load testing using Kubernetes operator.
...
* [gatling-sbt-plugin](https://github.com/gatling/gatling-sbt-plugin) ⭐ 108 | 🐛 1 | 🌐 Scala | 📅 2026-08-23 - Gatling SBT plugin to integrate Gatling with SBT, allowing to use Gatling as a testing framework.
...
* [gatling-maven-plugin](https://github.com/gatling/gatling-maven-plugin) ⭐ 38 | 🐛 1 | 🌐 Java | 📅 2026-08-24 - Gatling Maven Extensions.
* [gatling-gradle-plugin](https://github.com/gatling/gatling-gradle-plugin) ⭐ 30 | 🐛 1 | 🌐 Groovy | 📅 2026-08-25 - Gatling plugin for Gradle.
...
* [gatling-kafka-plugin](https://github.com/galax-io/gatling-kafka-plugin) ⭐ 22 | 🐛 23 | 🌐 Scala | 📅 2026-08-25 - Plugin for support Kafka in Gatling.
...
* [gatling-picatinny](https://github.com/galax-io/gatling-picatinny) ⭐ 12 | 🐛 60 | 🌐 Scala | 📅 2026-08-24 - Library with a bunch of useful functions that extend Gatling DSL.
...
* [gatling-jdbc-plugin](https://github.com/galax-io/gatling-jdbc-plugin) ⭐ 9 | 🐛 33 | 🌐 Scala | 📅 2026-08-23 - Simple Gatling plugin for JDBC support.
* [gatling-amqp-plugin](https://github.com/galax-io/gatling-amqp-plugin) ⭐ 7 | 🐛 4 | 🌐 Scala | 📅 2026-08-23 - Plugin for support performance testing with AMQP in Gatling (3.2.x).
...
* [gatling-build-plugin](https://github.com/gatling/gatling-build-plugin) ⭐ 3 | 🐛 1 | 🌐 Scala | 📅 2026-08-25 - An SBT plugin to share common settings across Gatling's projects' builds.
...
* [Kraken](https://github.com/OctoPerf/kraken) ⭐ 119 | 🐛 54 | 🌐 Java | 📅 2024-02-15 - Load testing IDE based on Gatling by OctoPerf.
...
* [gatling-report](https://github.com/nuxeo/gatling-report) ⭐ 127 | 🐛 14 | 🌐 Java | 📅 2026-08-04 - Parse Gatling simulation.log files to output CSV stats or build HTML reports with Plotly charts.
* [gatling-elasticsearch](https://github.com/Amerousful/gatling-elasticsearch-logs) ⭐ 14 | 🐛 6 | 🌐 Scala | 📅 2026-03-19 - Logger which parses raw Gatling logs and sends them to the Elasticsearch.
...
* [gatling-template.g8](https://github.com/galax-io/gatling-template.g8) ⚠️ Archived - A Giter8 template for Gatling performance test project.
...
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,357 | 🐛 9 | 📅 2026-08-22 - A curated list of testing resources.
