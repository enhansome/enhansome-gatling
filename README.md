...
* [Source code](https://github.com/gatling/gatling) ⭐ 6,956 | 🐛 20 | 🌐 Scala | 📅 2026-08-31
...
* [gatling-sbt-plugin](https://github.com/gatling/gatling-sbt-plugin) ⭐ 108 | 🐛 1 | 🌐 Scala | 📅 2026-09-04 - Gatling SBT plugin to integrate Gatling with SBT, allowing to use Gatling as a testing framework.
...
* [gatling-maven-plugin](https://github.com/gatling/gatling-maven-plugin) ⭐ 38 | 🐛 1 | 🌐 Java | 📅 2026-09-04 - Gatling Maven Extensions.
...
* [gatling-kafka-plugin](https://github.com/galax-io/gatling-kafka-plugin) ⭐ 22 | 🐛 26 | 🌐 Scala | 📅 2026-09-02 - Plugin for support Kafka in Gatling.
...
* [gatling-picatinny](https://github.com/galax-io/gatling-picatinny) ⭐ 12 | 🐛 55 | 🌐 Scala | 📅 2026-09-01 - Library with a bunch of useful functions that extend Gatling DSL.
...
* [gatling-jdbc-plugin](https://github.com/galax-io/gatling-jdbc-plugin) ⭐ 9 | 🐛 34 | 🌐 Scala | 📅 2026-08-30 - Simple Gatling plugin for JDBC support.
* [gatling-amqp-plugin](https://github.com/galax-io/gatling-amqp-plugin) ⭐ 7 | 🐛 5 | 🌐 Scala | 📅 2026-08-30 - Plugin for support performance testing with AMQP in Gatling (3.2.x).
...
* [gatling-build-plugin](https://github.com/gatling/gatling-build-plugin) ⭐ 3 | 🐛 0 | 🌐 Scala | 📅 2026-09-03 - An SBT plugin to share common settings across Gatling's projects' builds.
