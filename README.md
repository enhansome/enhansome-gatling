...
* [Source code](https://github.com/gatling/gatling) ⭐ 6,957 | 🐛 19 | 🌐 Scala | 📅 2026-09-07
...
* [gatling-maven-plugin](https://github.com/gatling/gatling-maven-plugin) ⭐ 38 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - Gatling Maven Extensions.
...
* [gatling-kafka-plugin](https://github.com/galax-io/gatling-kafka-plugin) ⭐ 22 | 🐛 29 | 🌐 Scala | 📅 2026-09-06 - Plugin for support Kafka in Gatling.
...
* [gatling-picatinny](https://github.com/galax-io/gatling-picatinny) ⭐ 12 | 🐛 59 | 🌐 Scala | 📅 2026-09-07 - Library with a bunch of useful functions that extend Gatling DSL.
...
* [gatling-jdbc-plugin](https://github.com/galax-io/gatling-jdbc-plugin) ⭐ 9 | 🐛 36 | 🌐 Scala | 📅 2026-09-06 - Simple Gatling plugin for JDBC support.
* [gatling-amqp-plugin](https://github.com/galax-io/gatling-amqp-plugin) ⭐ 7 | 🐛 6 | 🌐 Scala | 📅 2026-09-06 - Plugin for support performance testing with AMQP in Gatling (3.2.x).
...
* [gatling-build-plugin](https://github.com/gatling/gatling-build-plugin) ⭐ 3 | 🐛 0 | 🌐 Scala | 📅 2026-09-07 - An SBT plugin to share common settings across Gatling's projects' builds.
